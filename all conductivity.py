...
ax[1].fill_between(x, y_E_C, color=ce_Between, alpha=alpha)
ax[1].plot(x, y_E_E, linestyle='-', lw=lw, color=ee, label='E-E')
ax[1].fill_between(x, y_E_E, color=ee_Between, alpha=alpha)
...
ax[2].fill_between(x, y_B_E, color=eb_Between, alpha=alpha)
