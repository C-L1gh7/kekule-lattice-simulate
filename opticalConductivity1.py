...
y_0 = np.genfromtxt(mkpath0 + '/total_sigma_xx.txt', dtype=None) # with corner
y_02 = np.genfromtxt(mkpath02 + '/total_sigma_xx.txt', dtype=None) # without corner
y_047 = np.genfromtxt(mkpath047 + '/total_sigma_xx.txt', dtype=None) # without corner
...
# 图a绘制
ax[0].plot(x_mu, y_047, linestyle='-', lw=lw, color="#1DCDD3", label=r'$\mu = 0.47$', zorder=4)
# ax[0].fill_between(x_mu, y_047, color="#87E2E6", alpha=alpha)
ax[0].plot(x_mu, y_02, linestyle='-', lw=lw, color="#FF64F7", label=r'$\mu = 0.2$', zorder=4)
# ax[0].fill_between(x_mu, y_02, color="#FF8FDD", alpha=alpha)
ax[0].plot(x_mu, y_0, linestyle='-.', lw=lw, color="#37CE5D", label=r'$\mu = 0$', zorder=4)
...
ax[0].set_ylabel(r'$\Re(\sigma_{xx})\ [{\tilde t}^2 e^2/\hbar]$', fontsize=16)
...
# 图b绘制
ax[1].plot(x1, y1, linestyle='-', lw=lw, color="#2E5FFF", label=r'$\Gamma = 0.0005$', zorder=4)
# ax[1].fill_between(x1, y1, color="#7A99FF", alpha=alpha)
ax[1].plot(x2, y2, linestyle='-', lw=lw, color="#C572FD", label=r'$\Gamma = 0.001$', zorder=4)
# ax[1].fill_between(x2, y2, color="#D9A0FF", alpha=alpha)
ax[1].plot(x3, y3, linestyle='-', lw=lw, color="#FFB108", label=r'$\Gamma = 0.005$', zorder=4)
...
ax[1].plot(x6, y6, linestyle='-', lw=lw, color="#FF6565", label=r'$\Gamma = 0.03$', zorder=4)
...
ax[1].set_xlabel(r'$\hbar\omega\ [t]$', fontsize=16)
ax[1].set_ylabel(r'$\Re(\sigma_{xx})\ [{\tilde t}^2 e^2/\hbar]$', fontsize=16)
